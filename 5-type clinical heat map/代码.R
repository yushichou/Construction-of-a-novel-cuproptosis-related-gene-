...
library(tidyverse)
rownames(expCluster)=str_replace_all(rownames(expCluster),"TCGA_","")
rownames(expCluster)=str_replace_all(rownames(expCluster),"GSE63514_","")
...
#热图可视化
pdf("heatmap.pdf", height=6, width=9)
pheatmap(data,
         annotation=Type,
         annotation_colors = ann_colors,
         color = colorRampPalette(c(rep("blue",5), "black", rep("yellow",5)))(100),
         cluster_cols =F,
         cluster_rows =F,
         scale="row",
         show_colnames=F,
